...
<html>
	...
	<body>
		<div class="login-wrapper">
			<div class="bg-pic">
				<img src="<?= $this->Url->build(['controller'=>'Company','action'=>'Banner',true])?>" data-src="<?= $this->Url->build(['controller'=>'Company','action'=>'Banner',true])?>" data-src-retina="" alt="<?= $this->Url->build(['controller'=>'Company','action'=>'Banner',true])?>" class="lazy img-banner">
			...
			<div class="login-container bg-white">
				<div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
					<img class="img-logo"src="<?= $this->Url->build(['controller'=>'Company','action'=>'Logo',true])?>" alt="logo" data-src="<?= $this->Url->build(['controller'=>'Company','action'=>'Logo',true])?>" data-src-retina="<?= $this->Url->build(['controller'=>'Company','action'=>'Logo',true])?>" width="78" height="22">
					<p></p>
					<?= $this->fetch('content') ?>
				</div>
			</div>
